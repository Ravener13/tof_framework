...
#                        stack_batch_proc
# =============================================================================
def stack_batch_proc (src_dir, dst_dir, img_mask_img, ref_mask_img, proc_folder = [], ref_folder = '15_ref_bb', avg_seq = '', save_results = True, scrubbing = True, initial_HE_LE = (False, [3,23],[60,80]), final_HE_LE = (False, [3,23],[60,80]), **kwargs):
    '''
    ...
    for up_key, up_values in stack_dict.items():
        if '_ob' in up_key:
            for values in up_values:
                for img in values:
                    mod_for_ob (img[0], roi_original=[0,0,50,512], roi_mod=[462,0,50,512])
