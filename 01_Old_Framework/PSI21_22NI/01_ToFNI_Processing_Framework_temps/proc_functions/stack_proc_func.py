...
#                        stack_batch_proc
# =============================================================================
def stack_batch_proc (src_dir, dst_dir, ref_mask_img, img_mask_img, #ref, 
                      proc_folder = [], ref_folder = '15_ref_bb', avg_seq = [stack_avg], save_results = True, final_HE_LE = (False, [3,23],[60,80]), save_sbkg = False, **kwargs):
    '''
