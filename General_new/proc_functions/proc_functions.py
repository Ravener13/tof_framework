...
def binning_frames (acqs_folder, start_img = 0, frames_binning_factor = 10, HE_LE = (False, [15,30],[30,50]), **kwargs):
...
#                        separate_energies
# =============================================================================
def separate_energies (frames_folder, HE_slice = [5, 19], LE_slice = [36,50], **kwargs):
