...
def get_relative_att_stack (stack_dict, dst_dir, HE_n_LE, proc_folder = [], overwrite = False, save = True, casing_corr = [1,1], translate = [0,0], **kwargs):
    ...
    for key,values in trans_imgs_dict.items():
        ...
        #LE_avg = translate_img(LE_avg, translate = translate) #[vertical,horizontal]
