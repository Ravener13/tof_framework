...
def get_relative_att_stack (stack_dict, dst_dir, HE_n_LE, proc_folder = [], overwrite = False, save = True, **kwargs):
    ...
    for key,values in trans_imgs_dict.items():
        ...
        rel_img =relative_att_img(HE_avg, LE_avg, HE_range = HE, LE_range = LE)
